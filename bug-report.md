...
- [x] BigQuery error on startup:
  ...
  ```
- [x] Search autocomplete populates but doesn't execute query.
- [x] USGS earthquake data limited in scope (only see one earthquake) and not clickable
- [x] UI/UX AI assistant chat window can become hidden under top menu bar.
- [x] Street view hidden.
