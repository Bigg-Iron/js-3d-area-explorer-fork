...
[x] Dynamic orbit + toggle switch and sliders
[] Air quality data overlay
[] Weather data overlay
[x] Earthquake data overlay
[] Integration with Google Earth Engine
[] Integration with Sentinel-2
[x] Places API data layer
[x] Nearby search API to query nearby locations (amenities, points of interest, etc)
[x] 3D Aerial view + toggle switch to show / hide + integrated hovercards
[x] Interactive 3D markers
[] 3D storytelling customizations 
